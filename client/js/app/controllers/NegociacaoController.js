...
System.register(['../models/ListaNegociacoes', '../models/Menssagem', '../views/NegociacoesView', '../views/MensagemView', '../services/NegociacaoService', '../helpers/DateHelper', '../helpers/Bind', '../models/Negociacao'], function (_export, _context) {
    "use strict";
    ...
    return {
        ...
        }, function (_modelsMenssagem) {
            Mensagem = _modelsMenssagem.Mensagem;
